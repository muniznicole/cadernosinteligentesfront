...
export class AuthService {
  ...
  private usuarioLogadoSubject = new BehaviorSubject<Auth | null>(null);
  ...
  setUsuarioLogado(auth: Auth): void {
    this.localStorageService.setItem(this.usuarioLogadoKey, auth);
  }
